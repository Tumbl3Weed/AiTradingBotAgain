...
calconfig.NEOGA = {
  ...
  BEAR_RSI_high: 22.3,
  rsiVolume_low: 32.63,
  rsiVolume_high: 65.92,
  optInFastKPeriod: 38,
  optInSlowKPeriod: 7,
  optInSlowDPeriod: 13,
  baseBuyAmbitionVal: 0.9,
  bearBuyAmbitionVal: 0.81,
  baseSellAmbitionVal: 1.13,
  bearSellAmbitionVal: 0.96,
  usingRsiVolOpposite: true,
  sameSideCount: 1,
...
calconfig.tradingAdvisor = {
  enabled: true,
  method: 'NEOGA',//'NEOGA',
  candleSize: calconfig.NEOGA.candleSize,
  historySize: 60 * 24,
};
