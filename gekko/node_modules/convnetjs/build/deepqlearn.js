...
(function (global) {
  ...
  var Brain = function (num_states, num_actions, opt) {
    ...
    this.epsilon_min = typeof opt.epsilon_min !== 'undefined' ? opt.epsilon_min : 0.25;
    ...
    var tdtrainer_options = { learning_rate: 0.000079, momentum: 0.000001, batch_size: 64, l2_decay: 0.00000001 };
    ...
    this.epsilon = 1; // controls exploration exploitation tradeoff. Should be annealed over time
    this.latest_reward = 0;
    this.last_input_array = [];
    this.average_reward_window = new cnnutil.Window(10000, 10);
    this.average_loss_window = new cnnutil.Window(10000, 10);
    this.learning = true;
  }
  Brain.prototype = {
    ...
    forward: function (input_array) {
      ...
      if (this.forward_passes > this.temporal_window) {
        ...
        if (this.learning) {
          ...
          this.epsilon = Math.min(1.0, Math.max(this.epsilon_min, 1.0 - (this.age * 2 - this.learning_steps_burnin) / (this.learning_steps_total - this.learning_steps_burnin)));
